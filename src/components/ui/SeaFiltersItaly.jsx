...
const ITALY_FILTERS = [
  {
    id: "NORD",
    label: "Nord Italia",
    helper: "Liguria, alto Adriatico, laghi balneabili…",
  },
  {
    id: "CENTRO",
    label: "Centro Italia",
    helper: "Toscana, Lazio, coste centrali.",
  },
  {
    id: "SUD",
    label: "Sud Italia",
    helper: "Campania, Puglia, Calabria e dintorni.",
  },
  {
    id: "ISOLE",
    label: "Isole",
    helper: "Sardegna, Sicilia e arcipelaghi.",
  },
];
...
const SeaFiltersItaly = ({
    ...
    <div className="space-y-3">
      ...
      <div className="pt-1 space-y-2">
        <p className="text-[11px] text-slate-500">
          Puoi selezionare una o più macro-zone (Nord, Centro, Sud, Isole). Se
          non selezioni nulla, vedrai tutta Italia.
        </p>
  ...
  const renderCollapsedSidebar = () => (
    <div className="flex flex-col items-center gap-3 py-2">
      ...
      {/* pill verticali con iniziali */}
      <div className="flex flex-col items-center gap-2">
        {ITALY_FILTERS.map((f) => {
          const isActive = selectedFilters.includes(f.id);
          const label = f.label.charAt(0); // N / C / S / I
          ...
          return (
            <button
              ...
              onClick={() => toggleFilter(f.id)}
              title={f.label}
              className={`flex h-8 w-8 items-center justify-center rounded-full text-[11px] font-semibold shadow-sm transition ${
                isActive
      ...
      {/* reset come sola icona tonda rossa */}
      {hasActiveFilters && (
        <button
          type="button"
          onClick={handleReset}
