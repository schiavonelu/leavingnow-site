...
export const HONEYMOON_DESTINATIONS = [
  ...
  },
  {
    ...
    description:
      "Metropoli futuristica e deserto da un lato, isola thailandese con palme e mare caldo dall’altro. Perfetto per un viaggio di nozze che unisce scenari diversi ma complementari.",
  },
  ...
  },
  {
    ...
    period: "Novembre – Aprile",
    description:
      "Un itinerario tra Chiang Mai, Chiang Rai e i villaggi del nord, con templi, natura e incontri autentici, seguito da alcuni giorni di mare a Koh Samui. Un viaggio di nozze completo, tra scoperta e relax.",
  },

  {
    ...
    description:
      "Il Giappone tra città futuristiche, templi e tradizioni, con tappe a Tokyo, Kyoto e Osaka, e un finale di totale relax alle Maldive. Perfetto per chi sogna un grande viaggio culturale con chiusura al mare.",
  },

  {
    ...
    description:
      "Templi e risaie di Bali, una sosta a Singapore tra giardini futuristici e skyline, e poi mare da sogno alle Maldive. Un viaggio di nozze molto completo, tra spiritualità, città e lagune tropicali.",
  },
  ...
  },
  {
    ...
    period: "Dicembre – Aprile",
    description:
      "Un mix tra metropoli americana e isole da cartolina: New York all’inizio, poi una crociera che tocca varie isole delle Bahamas. Perfetto per chi ama il mare ma anche la comodità della nave.",
  },
  ...
  },
  {
    ...
    period: "Aprile – Ottobre",
    description:
      "On the road tra San Francisco e Los Angeles, con città iconiche e panorami della California, e finale di mare in Riviera Maya tra spiagge caraibiche e siti archeologici. Un viaggio di nozze lungo, completo e molto vario.",
  },

  {
    ...
    period: "Aprile – Ottobre",
    description:
      "Un percorso che unisce la magia di Istanbul, i paesaggi surreali della Cappadocia (anche in mongolfiera) e qualche giorno di mare a Bodrum. Ideale per chi cerca cultura, scenari unici e un tocco di mare.",
  },

  // ------------------------
  // DESTINAZIONI MARE “PIENO”
  // ------------------------
  ...
  },
  {
    ...
    period: "Maggio – Ottobre",
    description:
      "Lagune azzurre, overwater, isolette intime e resort iconici. Uno dei viaggi di nozze più desiderati al mondo, pensato per chi sogna un’esperienza davvero irripetibile.",
  },

  // ------------------------
  // SAFARI + MARE / ITINERARI RICCHI
  // ------------------------
  ...
  },
  {
    ...
    period: "Dicembre – Aprile",
    description:
      "Templi, piantagioni di tè, natura e piccoli lodge in Sri Lanka, con finale mare alle Maldive. Un viaggio di nozze con un bel ritmo e tante sfumature diverse.",
  },

  // ------------------------
  // ASIA, OCEANIA E GRANDI VIAGGI
  // ------------------------
  ...
  },
  {
    ...
    period: "Maggio – Ottobre",
    description:
      "Uno dei viaggi di nozze più iconici: lagune perfette, resort esclusivi e scenari che ti restano negli occhi per sempre. L’idea giusta se vuoi fare ‘il grande viaggio’.",
  },

  // ------------------------
  // STATI UNITI, ON THE ROAD E CROCIERE
  // ------------------------
