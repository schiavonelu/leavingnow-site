    ...
    <section className="relative h-screen w-full overflow-hidden bg-[#F8FAFC] text-[#132C50]">
      ...
      <div className="relative mx-auto flex h-full max-w-5xl flex-col px-4 py-4">
        ...
        <main className="flex flex-1 flex-col items-center justify-center text-center">
          <p
            className="text-[11px] sm:text-xs md:text-sm uppercase 
          ...
          <div className="w-full max-w-3xl">
            ...
            {lastMinute ? (
              <>
                <div
                  className="rounded-3xl bg-white/95 px-6 py-8
                ...
                >
                  ...
                  >
                    {Math.max(timeLeft.seconds, 0)}
                  </span>
                </div>

                <div
                  className="mt-4 h-1 w-24 mx-auto rounded-full 
                bg-linear-to-r from-[#0863D6] via-[#EB2480] to-amber-300 animate-pulse"
                />
              </>
            ) : (
              ...
              <>
                ...
                <div
                  className="mt-5 h-2 w-full max-w-3xl rounded-full 
                bg-slate-200 overflow-hidden mx-auto"
                >
                  <div
                    className="h-full bg-linear-to-r from-[#0863D6] via-[#EB2480] to-amber-300 
